...
###Missing values remark
As previously mentioned, there are no missing values. However, we can see that there are some 0 values in directorfl column but we can interpret them as they do not own any Facebook page.

```{r titleyear-to-categorical2, echo=TRUE}
...
###Univariate analysis
For univariate analysis, histograms and box plot were obtained for the numerical variables and bar charts were generated for the categorical variables. These are the results obtained:
